...
The [price service](https://github.com/pyth-network/pyth-crosschain/tree/main/price-service) is a webservice that listens to the Wormhole Network for Pyth price updates and serves them via a convenient web API.
